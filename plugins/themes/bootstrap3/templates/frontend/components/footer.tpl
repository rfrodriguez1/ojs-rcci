 ...
 *}
	...
	{if empty($isFullWidth)}
		...
		{if $sidebarCode}
			<aside id="sidebar" class="pkp_structure_sidebar left col-xs-12 col-sm-12 col-md-3 " role="complementary" aria-label="{translate|escape key="common.navigation.sidebar"}">
			...
			{if !$currentUser && $requestedPage != 'login'}
			<form class="login" id="login" method="post" action="{$baseUrl}/index.php/RCCI/login/signIn">
				{csrf}
			...
			<div class="pkp_block">
				...
				<div class="columns mt-5">
					<img src="{$baseUrl}/templates/images/img/v342_862.png" alt="">
				</div>
			</div>
			...
			<div class="pkp_block">
				...
				<div class="columns mt-5">
					<a target="_blank" href="https://scielo.sld.cu/scielo.php?script=sci_issues&pid=2227-1899&lng=es&nrm=iso"><img src="{$baseUrl}/templates/images/img/v342_861.png" alt=""></a>
					<a href="https://www.latindex.unam.mx/latindex/ficha?folio=22438"><img src="{$baseUrl}/templates/images/img/v342_860.png" alt=""></a>
					<a target="_blank" href="https://scholar.google.com.cu/citations?user=JDt_ldMAAAAJ&hl=en"><img src="{$baseUrl}/templates/images/img/v342_854.png" alt=""></a>
				</div>
				<div class="columns">
					<a target="_blank" href="https://v2.sherpa.ac.uk/id/publisher/2034"><img src="{$baseUrl}/templates/images/img/v342_858.png" alt=""></a>
					<a target="_blank" href="http://www.erevistas.csic.es/ficha_revista.php?oai_iden=oai_revista1151"><img src="{$baseUrl}/templates/images/img/v342_857.png" alt=""></a>
					<a target="_blank" href="https://www.redalyc.org/revista.oa?id=3783"><img src="{$baseUrl}/templates/images/img/v342_856.png" alt=""></a>
				</div>
			</div>
		...
		<div class="pkp_footer_brand">
			...
			<div class="pkp_footer_images">
				<div class="pkp_footer_image">
					...
					<img src="{$baseUrl}/templates/images/img/v342_808.png" alt="">
				</div>
				<div class="pkp_footer_image">
					<a href="https://uci.cu"><img src="{$baseUrl}/templates/images/img/v342_809.png" alt=""></a>
				</div>
				<div class="pkp_footer_image">
					<a href="http://www.uci.cu/investigacion-y-desarrollo/editorial"><img src="{$baseUrl}/templates/images/img/v342_810.png" alt=""></a>
				</div>
			</div>
		</div>
	</div>
