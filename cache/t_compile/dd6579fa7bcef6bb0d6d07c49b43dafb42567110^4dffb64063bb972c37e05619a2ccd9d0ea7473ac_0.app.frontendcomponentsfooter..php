<?php
/* Smarty version 3.1.39, created on 2024-03-24 16:48:07
  from 'app:frontendcomponentsfooter.' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_66009187cad918_98860737',
...
function content_66009187cad918_98860737 (Smarty_Internal_Template $_smarty_tpl) {
?>
	</main>
...
">
			...
			<form class="login" id="login" method="post" action="https://localhost/revcol/index.php/RCCI/login/signIn">
...
/templates/images/img/v342_862.png" alt="">
					<img src="<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/templates/images/img/v342_861.png" alt="">
					<img src="<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/templates/images/img/v342_860.png" alt="">
				</div>
				<div class="columns">
					<img src="<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/templates/images/img/v342_858.png" alt="">
					<img src="<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/templates/images/img/v342_857.png" alt="">
					<img src="<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/templates/images/img/v342_856.png" alt="">
				</div>
				<div class="columns">
					<img src="<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/templates/images/img/v342_854.png" alt="">
				</div>
			</div>
	...
	<div class="pkp_footer_content">
		...
		<div class="pkp_footer_brand">
			<p class="pkp_footer_text"
				>En este espacio habra una breve descripcion de la revista RCCC ,
				asi como su editorial , el año de creaada, y en donde fue creada,
				ncndnadsnsdc.sd cdcmdc,dcn,dscns dnlcdlncdncdndncsnsdsd
				ca,ajcdncdncdncanad ,jcbac,a nnc
			</p>
...
/templates/images/img/v342_808.png" alt="">
				...
				<div class="pkp_footer_image">
					<img src="<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/templates/images/img/v342_809.png" alt="">
				</div>
				<div class="pkp_footer_image">
					<img src="<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/templates/images/img/v342_810.png" alt="">
				</div>
			</div>
		</div>
