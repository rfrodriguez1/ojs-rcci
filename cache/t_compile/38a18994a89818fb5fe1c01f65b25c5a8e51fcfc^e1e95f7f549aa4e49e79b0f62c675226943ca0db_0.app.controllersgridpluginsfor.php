<?php
/* Smarty version 3.1.39, created on 2024-03-19 16:21:27
  from 'app:controllersgridpluginsfor' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_65f9f3c75b8156_55353890',
...
function content_65f9f3c75b8156_55353890 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
>
	$(function() {
		...
		$('#uploadPluginForm').pkpHandler(
			'$.pkp.controllers.form.FileUploadFormHandler',
			{
				$uploader: $('#plupload'),
				uploaderOptions: {
					uploadUrl: <?php echo json_encode(call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('router'=>(defined('ROUTE_COMPONENT') ? constant('ROUTE_COMPONENT') : null),'op'=>"uploadPluginFile",'function'=>$_smarty_tpl->tpl_vars['function']->value,'escape'=>false),$_smarty_tpl ) ));?>
,
