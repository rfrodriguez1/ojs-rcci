<?php
/* Smarty version 3.1.39, created on 2024-03-19 01:41:08
  from 'app:controllersgridsettingsca' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_65f92574f111d5_59321737',
...
function content_65f92574f111d5_59321737 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
...
ob_start();?>
			<?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, 'default', "instruct", null);?>
				<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('router'=>(defined('ROUTE_PAGE') ? constant('ROUTE_PAGE') : null),'page'=>"catalog",'op'=>"category",'path'=>"path"),$_smarty_tpl ) );?>
...
" src="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('router'=>(defined('ROUTE_PAGE') ? constant('ROUTE_PAGE') : null),'page'=>"catalog",'op'=>"thumbnail",'type'=>"category",'id'=>$_smarty_tpl->tpl_vars['categoryId']->value),$_smarty_tpl ) );?>
...
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		...
		<?php if (count($_smarty_tpl->tpl_vars['availableSubeditors']->value)) {?>
...
$_smarty_tpl->smarty->_cache['_tag_stack'][] = array('fbvFormSection', array('list'=>true,'title'=>"submissionGroup.assignedSubEditors"));
$_block_repeat=true;
echo $_block_plugin9->smartyFBVFormSection(array('list'=>true,'title'=>"submissionGroup.assignedSubEditors"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
				<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['availableSubeditors']->value, 'subEditor', false, 'id');
...
?>
					<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"checkbox",'id'=>"subEditors[]",'value'=>$_smarty_tpl->tpl_vars['id']->value,'checked'=>in_array($_smarty_tpl->tpl_vars['id']->value,$_smarty_tpl->tpl_vars['assignedToCategory']->value),'label'=>call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['subEditor']->value )),'translate'=>false),$_smarty_tpl ) );?>

				<?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
			<?php $_block_repeat=false;
echo $_block_plugin9->smartyFBVFormSection(array('list'=>true,'title'=>"submissionGroup.assignedSubEditors"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
